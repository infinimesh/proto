...
const (
	...
	EventKind_NAMESPACE_CREATE EventKind = 4
	EventKind_NAMESPACE_UPDATE EventKind = 5
	EventKind_NAMESPACE_DELETE EventKind = 6
	EventKind_DEVICE_CREATE    EventKind = 7
	EventKind_DEVICE_UPDATE    EventKind = 8
	EventKind_DEVICE_DELETE    EventKind = 9
)
