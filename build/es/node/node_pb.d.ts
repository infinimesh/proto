...
export declare class JoinGeneralRequest extends Message<JoinGeneralRequest> {
  /**
   * Node to make Join to (can be interpret differenetly depending on Controller)
   *
  ...
  /**
   * Node to make Join from (can be interpret differenetly depending on Controller)
   *
